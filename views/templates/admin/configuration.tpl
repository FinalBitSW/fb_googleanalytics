...
<div class="panel">
	<h3><i class="icon icon-credit-card"></i> {l s='FinalBit Google Analytics' mod='fb_googleanalytics'}</h3>
	<p>
		<strong>{l s='This module is free!' mod='fb_googleanalytics'}</strong><br />
		{l s='Is it usfull and you like it?' mod='fb_googleanalytics'}<br />
		{l s='We would be glad about a donation to enable the further development as well as new development of further modules.' mod='fb_googleanalytics'}
	</p>
	<br />
	<p>
		{l s='This module will boost your sales!' mod='fb_googleanalytics'}
	</p>
	<br />
	<p>
		<strong>{l s='Make your donation now! Thank you!!' mod='fb_googleanalytics'}</strong>
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
		<input type="hidden" name="cmd" value="_s-xclick">
		<input type="hidden" name="hosted_button_id" value="CXDLFHXCWZV36">
...
<div class="panel">
	<h3><i class="icon icon-tags"></i> {l s='Documentation' mod='fb_googleanalytics'}</h3>
	<p>
		&raquo; {l s='You can get a PDF documentation to configure this module' mod='fb_googleanalytics'} :
		<ul>
			<li><a href="https://github.com/FinalBitSW/fb_googleanalytics/wiki" target="_blank">{l s='English' mod='fb_googleanalytics'}</a></li>
		</ul>
	</p>
</div>